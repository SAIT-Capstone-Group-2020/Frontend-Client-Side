			...
			<div className="nav-items">
				...
				<div className="nav-wrap">
					<nav role="navigation" className="nav-items w-nav-menu">
						<a href="/#" aria-current="page" className="nav-item w-nav-link w--current">
							Home
						</a>
              ...
              <button>Products</button>
						...
						<a href="/#/products" onClick={handleProductsLink} className="nav-item w-nav-link">
							Products
						</a>
					...
					<div className="w-commerce-commercecartwrapper cart">
						...
						>
							...
							<div className="w-commerce-commercecartopenlinkcount card-quantity">{state.length}</div>
						</button>
