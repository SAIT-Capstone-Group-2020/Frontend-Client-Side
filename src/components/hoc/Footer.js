    ...
    <div className="footer-container">
      <div className="w-layout-grid footer">
        <div className="footer-div">
          <a href="#" className="nav-logo-link w-inline-block"><img src="./images/hha-logo.jpg" width="100" height="100" sizes="(max-width: 479px) 100vw, 100px" alt="Hiep Hoa Asian Food Market" className="logo-footer"/></a>
        </div>
        <div className="footer-div">
